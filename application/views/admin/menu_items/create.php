...
<div class="row">
	...
	<!-- Basic layout-->
	<form action="<?php echo base_url('admin/menu_items/add');?>" method="POST" class="form-horizontal" enctype="multipart/form-data">
				...
				<div class="form-group">
					<label class="col-lg-3 control-label">Ingredient:</label>
					 <div class="col-lg-9">
					   ...
					   <input type="text" class="form-control" placeholder="Description" name="ingredient">
					 </div>
				</div>
