...
<script type="text/javascript" src="<?php echo site_url('assets/js/pages/form_layouts.js'); ?>"></script>
	<!-- /core JS files -->
	...
	<script type="text/javascript" src="<?php echo site_url('assets/js/pages/datatables_advanced.js'); ?>"></script>
	<script type="text/javascript" src="<?php echo site_url('assets/js/plugins/tables/datatables/datatables.min.js'); ?>"></script>
		<script type="text/javascript" src="<?php echo site_url('assets/js/plugins/forms/selects/select2.min.js'); ?>"></script>
	

 	<!-- Theme JS files -->
	<script type="text/javascript" src="<?php echo site_url('assets/js/plugins/notifications/jgrowl.min.js'); ?>"></script>
	<script type="text/javascript" src="<?php echo site_url('assets/js/plugins/ui/moment/moment.min.js'); ?>"></script>
	<script type="text/javascript" src="<?php echo site_url('assets/js/plugins/pickers/daterangepicker.js'); ?>"></script>
	...
	<script type="text/javascript" src="<?php echo site_url('assets/js/plugins/pickers/pickadate/picker.time.js'); ?>"></script>
	<script type="text/javascript" src="<?php echo site_url('assets/js/plugins/pickers/pickadate/legacy.js'); ?>"></script>

	<script type="text/javascript" src="<?php echo site_url('assets/js/core/app.js'); ?>"></script>
	<script type="text/javascript" src="<?php echo site_url('assets/js/pages/picker_date.js'); ?>"></script>
	<!-- /theme JS files -->
</head>
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<li class="dropdown">
					...
					<div class="dropdown-menu dropdown-content width-350">
						...
						<ul class="media-list dropdown-content-body">
							...
							<li class="media">
								<div class="media-left"><img src="<?php base_url('assets/images/placeholder.jpg'); ?>" class="img-circle img-sm" alt=""></div>
								<div class="media-body">
									<a href="#" class="media-heading">
				...
				<li class="dropdown dropdown-user">
					...
					<ul class="dropdown-menu dropdown-menu-right">
						...
						<li><a href="<?php echo site_url('admin/login/logout'); ?>"><i class="icon-switch2"></i> Logout</a></li>
					...
					<div class="sidebar-category sidebar-category-visible">
						<div class="category-content no-padding">
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li>
									<a href="<?php echo base_url('admin/specialities'); ?>"><i class="icon-stack2"></i> <span>Specialities</span></a>
									
								</li>
																<li>
									<a href="<?php echo base_url('admin/menu_items'); ?>"><i class="icon-stack2"></i> <span>Menu Items</span></a>
									
								</li>
								<li>
									<a href="<?php echo base_url('admin/chefs'); ?>"><i class="icon-stack2"></i> <span>Chefs</span></a>
									
								</li>
								<li>
									<a href="<?php echo base_url('admin/categories'); ?>"><i class="icon-stack2"></i> <span>Categories</span></a>
									
								</li>
								<li>
									<a href="<?php echo base_url('admin/reservations'); ?>"><i class="icon-stack2"></i> <span>Reservations</span></a>
									
								</li>
								<li>
									<a href="<?php echo base_url('admin/contacts'); ?>"><i class="icon-stack2"></i> <span>Contacts</span></a>
									
								</li>
								<li>
									<a href="<?php echo base_url('admin/subscriptions'); ?>"><i class="icon-stack2"></i> <span>Subscriptions</span></a>
									
								</li>
								<li>
									<a href="<?php echo base_url('admin/working_hours'); ?>"><i class="icon-stack2"></i> <span>Working Hours</span></a>
									
								</li>
								<li>
									<a href="<?php echo base_url('admin/website_info'); ?>"><i class="icon-stack2"></i> <span>Website Information</span></a>
