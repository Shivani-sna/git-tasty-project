	...
	<div class="page-header-content">
		<div class="page-title">
			<h4><i class="icon-arrow-left52 position-left"></i> 
				<span class="text-semibold">Home</span> - subscriptions
			</h4>
		</div>
				...
				<span>Schedule</span>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li class="active"><a href="<?php echo base_url('admin/subscriptions'); ?>">subscriptions</a></li>
...
?>
							...
							<tr id="<?php echo $subscription->id; ?>"> 
							<td><?php echo $loop++; ?></td> 	
