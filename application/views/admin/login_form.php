...
<head>
	...
	<!-- Theme JS files -->
	<script type="text/javascript" src="<?php site_url('assets/js/core/app.js'); ?>"></script>
	<!-- /theme JS files -->
					...
					<form action="<?php echo base_url('admin/login/check_login'); ?>" method="post">
						<div class="panel panel-body login-form">
							...
							<div class="form-group">
								<button type="submit" class="btn btn-primary btn-block" name="login">Sign in <i class="icon-circle-right2 position-right"></i></button>
							</div>
