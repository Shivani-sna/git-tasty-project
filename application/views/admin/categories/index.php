					...
					<div class="panel panel-flat">
						...
						<div class="panel-heading">
							<div class="container">
								...
								<a href="<?php echo site_url('admin/categories/add'); ?>" class="btn btn-primary pull-left"><i class="glyphicon glyphicon-plus"></i> Add New</a>
		                	</div>
...
?>
							...
							<?php foreach ($categories as $category) {?>
								...
								<td><?php echo $loop++; ?></td> 
								<td><?php echo $category->icon;?>
								</td>
								<td><?php echo $category->name; ?></td>
								<td><?php echo $category->status; ?></td>
								

									<td><a href="<?php echo base_url("admin/categories/update/").$category->id; ?>">
